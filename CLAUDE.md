...
| `reps-foco-sonido` | `"0"` o ausente (= encendido) | Preferencia: sonido/vibración al terminar el ciclo de foco. La campanita se sintetiza con Web Audio (sin archivos); el `AudioContext` se desbloquea en el gesto de "Empezar". Clave aditiva. |
